  ...
  const products: Product[] = [
    {
      ...
      price: "$999",
      imageUrl:
        "https://m.media-amazon.com/images/I/91qguXr7q1L._AC_UF1000,1000_QL80_.jpg",
    },
    {
      name: "Samsung S25",
      ...
      price: "$100000",
      imageUrl:
        "https://images-cdn.ubuy.co.id/6668b80ebcd55c0f740671f8-kids-toys-barbie-mobile-phone-for-kids.jpg",
    },
    {
      name: "Iphone 16",
    ...
    },
    {
      ...
      price: "$1999",
      imageUrl:
        "https://plus.unsplash.com/premium_photo-1663091701962-2ae72a2ad2ac?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8dnJ8ZW58MHx8MHx8fDA%3D",
    },
    {
      name: "Ultrakill",
    ...
    },
    {
      ...
      price: "$2",
      imageUrl:
        "https://portableaudio.co.id/wp-content/uploads/2024/08/12_b1f4d49f-9f1f-4e70-a104-1c4a9b8283b4_2048x.png",
    },
  ];
  return (
    // <> == fragments
